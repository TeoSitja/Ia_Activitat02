    ...
    public override void OnConstruction()
    {
         ...
         */
         ...
         State travelThrowWaypoints = new State("travelThrowWaypoints",
            () => {_pathFeeder.target=_cat_BlackBoard.ChangeWaypoint();_pathFeeder.path=true;}, // write on enter logic inside {}
        ...
        Transition ChangeWaypoint = new Transition("ChangeWaypoint",
          ...
          Transition FishEated = new Transition("FishEated",
            ...
            () => {_fish.SetActive(false);_fish=null;}  // write the on trigger code in {} if any. Remove line if no on trigger action needed
        );
